...
<head>
  ...
  <link rel="stylesheet" href="css/checkout-choose-shipping-payment.css">
  <link rel="stylesheet" href="css/checkout-progress.css"></link>
...
<main class="container">
  <section class="summary-card">
    ...
    <form>
      ...
      <button type="button" onclick="window.location.href='checkout-choosing-payment.html'">Pokračovať k platbe</button>
    </form>
  </section>
</main>
