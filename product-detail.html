...
<head>
  ...
  <link rel="stylesheet" href="css/size-selector.css"></link>
...
<!--  Just thumbnail-->
  ...
  <section class="product-description">
    ...
    <span id="product-price">100 $</span>
    <p>
    ...
    <h2>
      ...
      <fieldset class="size-selector">
        ...
        <label><input type="radio" name="size" value="M">
          <span>M</span>
        </label>

        <label><input type="radio" name="size" value="L" checked>
          <span>L</span>
        </label>

        <label><input type="radio" name="size" value="XL">
          <span>XL</span>
        </label>
    ...
    <section class="product-quantity">
      ...
      <button class="add-to-cart" onclick="window.location.href='shopping_cart.html'">Pridaj do košíka</button>
