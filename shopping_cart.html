...
<div class="container">
  ...
  <div class="cart-items">
    ...
    <div class="item">
      <img alt="Nohavice_1" src="images/nohavice_1.webp">
      <div class="details">
        <h3>Nohavice_1</h3>
        <span>Veľkosť: L</span>
    ...
    <div class="item">
      <img alt="Bunda" src="images/budna_1.jpg.webp">
      <div class="details">
        <h3>Bunda_1</h3>
        <span>Veľkosť: L</span>
        <span class="price">$100</span>
    ...
    <div class="item">
      <img alt="Bunda_2" src="images/bunda_2.webp">
      <div class="details">
        <h3>Bunda_2</h3>
  ...
  <div class="summary">
    ...
    <div class="subtotal">Medzisúčet:
      <span>$300</span> bez dopravy
    </div>
    <button onclick="window.location.href='checkout_address.html'">Pokračovať na dopravu</button>
  </div>
